  ...
  displayContent() {
    return html`
        ...
        <form id="eventForm">
            ...
            <input type="number" id="eventXCoordinate" required @input=${this.updateSaveButtonState.bind(this)}
                   step="any"/>
            <br/><br/>
            <label for="eventYCoordinate">Y-Koordinate:</label>
            <input type="number" id="eventYCoordinate" required @input=${this.updateSaveButtonState.bind(this)}
                   step="any"/>
            <br/><br/>
